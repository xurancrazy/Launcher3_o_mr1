...
public class InvariantDeviceProfile {
    ...
    InvariantDeviceProfile(Context context) {
        ...
        LoggerUtils.i(getClass().getSimpleName(), "iconSize = " + iconSize
        ...
        LoggerUtils.i(getClass().getSimpleName(),"smallestSize = " + smallestSize
...
//        }
        profiles.add(new InvariantDeviceProfile("blanc",270,540,5,5,5,5,5,56,32,12,5,R.xml.default_workspace_5x5,0));
        return profiles;
    }
    ...
    InvariantDeviceProfile invDistWeightedInterpolate(float width, float height,
        ...
        LoggerUtils.i(getClass().getSimpleName(), "width = " + width
                + ",height = " + height
