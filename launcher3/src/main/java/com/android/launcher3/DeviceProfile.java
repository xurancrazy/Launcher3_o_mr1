...
public class DeviceProfile {
    ...
    private void updateIconSize(float scale, Resources res, DisplayMetrics dm) {
        ...
        LoggerUtils.i(getClass().getSimpleName(),"inv.landscapeIconSize = " + inv.landscapeIconSize
                + ",inv.iconSize = " + inv.iconSize
                + ",invIconSizePx = " + invIconSizePx);
    ...
    public Point getCellSize() {
        ...
        LoggerUtils.i(getClass().getSimpleName(),"padding = " + padding);
        LoggerUtils.i(getClass().getSimpleName(),"availableWidthPx = " + padding
                + ",availableWidthPx = " + availableWidthPx
                + ",padding.x = " + padding.x
                + ",cellLayoutPaddingLeftRightPx = " + cellLayoutPaddingLeftRightPx
                + ",inv.numColumns = " + inv.numColumns);
